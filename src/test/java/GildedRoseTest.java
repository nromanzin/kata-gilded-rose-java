...
public class GildedRoseTest {
    ...
    public void agedBrieIncreaseInQuality() {
        GildedRose tavern = initTavern(new Item(GildedRose.AGED_BRIE, 10, 10));
        tavern.updateQuality();
        assertEquals(GildedRose.AGED_BRIE, tavern.items[0].name);
        assertEquals(9, tavern.items[0].sellIn);
    ...
    public void qualityIsNeverAbove50() {
        GildedRose tavern = initTavern(new Item(GildedRose.AGED_BRIE, 10, 50));
        tavern.updateQuality();
        assertEquals(GildedRose.AGED_BRIE, tavern.items[0].name);
        assertEquals(9, tavern.items[0].sellIn);
    ...
    public void sulfurasIsLegendary() {
        GildedRose tavern = initTavern(new Item(GildedRose.SULFURAS, 10, 10));
        tavern.updateQuality();
        assertEquals(GildedRose.SULFURAS, tavern.items[0].name);
    ...
    public void backstagePassesIncreaseInQuality() {
        GildedRose tavern = initTavern(new Item(GildedRose.BACKSTAGE_PASSES, 15, 10));
        tavern.updateQuality();
        assertEquals(GildedRose.BACKSTAGE_PASSES, tavern.items[0].name);
    ...
    public void backstagePassesIncrease2InQualityWhen10DaysLeft() {
        GildedRose tavern = initTavern(new Item(GildedRose.BACKSTAGE_PASSES, 10, 10));
        tavern.updateQuality();
        assertEquals(GildedRose.BACKSTAGE_PASSES, tavern.items[0].name);
        assertEquals(9, tavern.items[0].sellIn);
        assertEquals(12, tavern.items[0].quality);
    ...
    public void backstagePassesIncrease3InQualityWhen5DaysLeft() {
        GildedRose tavern = initTavern(new Item(GildedRose.BACKSTAGE_PASSES, 5, 10));
        tavern.updateQuality();
        assertEquals(GildedRose.BACKSTAGE_PASSES, tavern.items[0].name);
    ...
    public void backstagePassesQualityIsZeroAfterConcert() {
        GildedRose tavern = initTavern(new Item(GildedRose.BACKSTAGE_PASSES, 0, 10));
        tavern.updateQuality();
        assertEquals(GildedRose.BACKSTAGE_PASSES, tavern.items[0].name);
        assertEquals(-1, tavern.items[0].sellIn);
        assertEquals(0, tavern.items[0].quality);
